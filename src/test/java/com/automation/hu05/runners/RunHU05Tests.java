...
@ConfigurationParameter(key = "cucumber.features", value = "classpath:features/hu05_event_registration.feature")
@ConfigurationParameter(key = "cucumber.plugin", value = "pretty, html:target/cucumber-reports/hu05-report.html")
